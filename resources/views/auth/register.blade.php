...
@section('content')
    ...
    <div class="p-8 text-center">
        <h1 class="text-4xl font-hairline text-red-600"><i class="fas fa-door-open mr-6"></i>Регистрация</h1>
    </div>
    ...
    <div class="p-8 text-center">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <button type="submit"
                        class="px-4 py-2 bg-red-600 rounded-lg text-gray-100 text-xl font-hairline text-uppercase hover:bg-red-400 mt-6">
                    Готово
                </button>

                <a class="px-4 py-2 bg-red-600 rounded-lg text-gray-100 text-xl font-hairline text-uppercase hover:bg-red-400 mt-6"
                   href="{{ route('password.request') }}">
                    Хочу зарегистрировать свой сервис проката!
                </a>
            </div>
        </form>
    </div>
